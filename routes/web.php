...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/exercise', function () {return view('user.pages.exercise');})->name('exercise');
    Route::get('/history', [HomeController::class, 'viewHistory'])->name('history');
    Route::get('/rank', [HomeController::class, 'viewRank'])->name('rank');
    Route::get('/discussion', function () {return view('user.pages.discussion');})->name('discussion');
    Route::get('/pack', function () {return view('user.pages.pack');})->name('pack');
    Route::get('/materi', function () {return view('user.pages.materi');})->name('materi');
    Route::get('/pembahasan', [OrderController::class, 'viewPembahasan'])->name('pembahasan');
    Route::get('/review', function () {return view('user.pages.review');})->name('review');
...
// Route Category
Route::middleware('auth')->group(function () {
    Route::get('/category/cpns', function () {return view('user.category.cpns.cpns-list');})->name('/category/cpns');
    Route::get('/category/polri', function () {return view('user.category.polri.polri-list');})->name('/category/polri');
    Route::get('/category/tni', function () {return view('user.category.tni.tni-list');})->name('/category/tni');
    Route::get('/category/sekdin', function () {return view('user.category.sekdin.sekdin-list');})->name('/category/sekdin');
});

// Route Exercise
Route::middleware('auth')->group(function () {
    Route::get('/exercise/cpns', function () {return view('user.exercise.cpns.cpns-list');})->name('/exercise/cpns');
    Route::get('/exercise/polri', function () {return view('user.exercise.polri.polri-list');})->name('/exercise/polri');
    Route::get('/exercise/tni', function () {return view('user.exercise.tni.tni-list');})->name('/exercise/tni');
    Route::get('/exercise/sekdin', function () {return view('user.exercise.sekdin.sekdin-list');})->name('/exercise/sekdin');
});

// Route CPNS
Route::middleware('auth')->group(function () {
    // Route::get('/category/cpns/skd-cpns', function () {return view('user.category.cpns.skd-cpns');})->name('/category/cpns/skd-cpns');
    Route::get('/category/cpns/skb-cpns', function () {return view('user.category.cpns.skb-cpns');})->name('/category/cpns/skb-cpns');
    Route::get('/category/cpns/lainnya-cpns', function () {return view('user.category.cpns.lainnya-cpns');})->name('/category/cpns/lainnya-cpns');
    ...
    Route::get('/category/cpns/lainnya-cpns/psikotes-cpns', function () {return view('user.category.cpns.skb.psikologi-cpns');})->name('/category/cpns/lainnya-cpns/psikotes-cpns');

    // Route::get('/category/cpns/skd-cpns', function () {return view('user.category.cpns.skd-cpns');})->name('/category/cpns/skd-cpns');
    Route::get('/exercise/cpns/skb-cpns', function () {return view('user.exercise.cpns.skb-cpns');})->name('/exercise/cpns/skb-cpns');
    Route::get('/exercise/cpns/lainnya-cpns', function () {return view('user.exercise.cpns.lainnya-cpns');})->name('/exercise/cpns/lainnya-cpns');
    ...
    Route::get('/exercise/cpns/lainnya-cpns/psikotes-cpns', function () {return view('user.exercise.cpns.skb.psikologi-cpns');})->name('/exercise/cpns/lainnya-cpns/psikotes-cpns');
...
// Route Sekdin
Route::middleware('auth')->group(function () {
    Route::get('/category/sekdin/akademik-sekdin', function () {return view('user.category.sekdin.akademik-sekdin');})->name('/category/sekdin/akademik-sekdin');
    Route::get('/category/sekdin/lanjutan-sekdin', function () {return view('user.category.sekdin.lanjutan-sekdin');})->name('/category/sekdin/lanjutan-sekdin');

    // Route Sekdin Lanjutan
    Route::get('/category/sekdin/lanjutan-sekdin/akademik-sekdin', function () {return view('user.category.sekdin.lanjutan.akademik-sekdin');})->name('/category/sekdin/lanjutan-sekdin/akademik-sekdin');
    Route::get('/category/sekdin/lanjutan-sekdin/psikologi-sekdin', function () {return view('user.category.sekdin.lanjutan.psikologi-sekdin');})->name('/category/sekdin/lanjutan-sekdin/psikologi-sekdin');

    // Route Psikologi CPNS
    Route::get('/category/sekdin/lanjutan-sekdin/psikologi-sekdin/tes-kecerdasan', function () {return view('user.category.sekdin.lanjutan.psikologi.tes-kecerdasan');})->name('/category/sekdin/lanjutan-sekdin/psikologi-sekdin/tes-kecerdasan');
    Route::get('/category/sekdin/lanjutan-sekdin/psikologi-sekdin/tes-kecermatan', function () {return view('user.category.sekdin.lanjutan.psikologi.tes-kecermatan');})->name('/category/sekdin/lanjutan-sekdin/psikologi-sekdin/tes-kecermatan');
    Route::get('/category/sekdin/lanjutan-sekdin/psikologi-sekdin/tes-kepribadian', function () {return view('user.category.sekdin.lanjutan.psikologi.tes-kepribadian');})->name('/category/sekdin/lanjutan-sekdin/psikologi-sekdin/tes-kepribadian');

    Route::get('/exercise/sekdin/akademik-sekdin', function () {return view('user.exercise.sekdin.akademik-sekdin');})->name('/exercise/sekdin/akademik-sekdin');
    Route::get('/exercise/sekdin/lanjutan-sekdin', function () {return view('user.exercise.sekdin.lanjutan-sekdin');})->name('/exercise/sekdin/lanjutan-sekdin');

    // Route Sekdin Lanjutan
    Route::get('/exercise/sekdin/lanjutan-sekdin/akademik-sekdin', function () {return view('user.exercise.sekdin.lanjutan.akademik-sekdin');})->name('/exercise/sekdin/lanjutan-sekdin/akademik-sekdin');
    Route::get('/exercise/sekdin/lanjutan-sekdin/psikologi-sekdin', function () {return view('user.exercise.sekdin.lanjutan.psikologi-sekdin');})->name('/exercise/sekdin/lanjutan-sekdin/psikologi-sekdin');

    // Route Psikologi CPNS
    Route::get('/exercise/sekdin/lanjutan-sekdin/psikologi-sekdin/tes-kecerdasan', function () {return view('user.exercise.sekdin.lanjutan.psikologi.tes-kecerdasan');})->name('/exercise/sekdin/lanjutan-sekdin/psikologi-sekdin/tes-kecerdasan');
    Route::get('/exercise/sekdin/lanjutan-sekdin/psikologi-sekdin/tes-kecermatan', function () {return view('user.exercise.sekdin.lanjutan.psikologi.tes-kecermatan');})->name('/exercise/sekdin/lanjutan-sekdin/psikologi-sekdin/tes-kecermatan');
    Route::get('/exercise/sekdin/lanjutan-sekdin/psikologi-sekdin/tes-kepribadian', function () {return view('user.exercise.sekdin.lanjutan.psikologi.tes-kepribadian');})->name('/exercise/sekdin/lanjutan-sekdin/psikologi-sekdin/tes-kepribadian');
});

// Route POLRI
Route::middleware('auth')->group(function () {
    Route::get('/category/polri/psikologi-polri', function () {return view('user.category.polri.psikologi-polri');})->name('/category/polri/psikologi-polri');
    ...
    Route::get('/exercise/polri/psikologi-polri', function () {return view('user.exercise.polri.psikologi-polri');})->name('/exercise/polri/psikologi-polri');
    Route::get('/exercise/polri/akademik-polri', function () {return view('user.exercise.polri.akademik-polri');})->name('/exercise/polri/akademik-polri');
    Route::get('/exercise/polri/lainnya-polri', function () {return view('user.exercise.polri.lainnya-polri');})->name('/exercise/polri/lainnya-polri');
...
// Route TNI
Route::middleware('auth')->group(function () {
    Route::get('/category/tni/skd-tni', function () {return view('user.category.tni.skd-tni');})->name('/category/tni/skd-tni');
    Route::get('/category/tni/psikologi-tni', function () {return view('user.category.tni.psikologi-tni');})->name('/category/tni/psikologi-tni');
    Route::get('/category/tni/akademik-tni', function () {return view('user.category.tni.akademik-tni');})->name('/category/tni/akademik-tni');

    // Route Psikologi TNI
    Route::get('/category/tni/psikologi-tni/tes-kecerdasan', function () {return view('user.category.tni.psikologi.tes-kecerdasan');})->name('/category/tni/psikologi-tni/tes-kecerdasan');
    Route::get('/category/tni/psikologi-tni/tes-kecermatan', function () {return view('user.category.tni.psikologi.tes-kecermatan');})->name('/category/tni/psikologi-tni/tes-kecermatan');
    Route::get('/category/tni/psikologi-tni/tes-kepribadian', function () {return view('user.category.tni.psikologi.tes-kepribadian');})->name('/category/tni/psikologi-tni/tes-kepribadian');
});
...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/soal-coba', function(){return view('user.soal.soal-baru');});
});
