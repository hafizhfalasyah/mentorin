...
class OrderController extends Controller
{
    public function viewOrder(){
        ...
        foreach($orders as $order){
            ...
            if($latihan_soal==0) $tampil->push($string_type);
        }
    ...
    public function viewOrderDetails($test){
        ...
        if($test=='polri'){
            ...
            foreach($orders as $order){
                ...
                if($string_type!='POL') continue;
                if($string == 'PKC' or $string == 'PCM' or $string == 'PKR' or $string == 'PPH'){
                    $string = 'PSI';
                }
                else if($string == 'TPU' or $string == 'TPN' or $string == 'TWK' or $string == 'TBG' or $string == 'TPA' or $string == 'TBI'){
                    $string = 'AKA';
                }
                else if($string == 'TKJ' or $string == 'PMK'){
                    $string = 'LAI';
                }
                $latihan_soal = Paket::where('id', $order['id_paket'])->get()->first()->latihan_soal;
                if($latihan_soal==0) $tampil->push($string);
            }
            ...
            foreach($orders as $order){
                ...
                else if($string == 'PKC' or $string == 'PCM' or $string == 'PKR' or $string == 'AKA' or $string == 'KEJ' or $string == 'PRA'){
                    $string = 'LAI';
                }
                $latihan_soal = Paket::where('id', $order['id_paket'])->get()->first()->latihan_soal;
                if($latihan_soal==0) $tampil->push($string);
    ...
    public function viewOrderTypes($test, $type){
        ...
        if($test=='polri'){
            ...
            foreach($orders as $order){
                ...
                else if($string == 'PKC' or $string == 'PCM' or $string == 'PKR' or $string == 'PRA' or $string == 'AKA' or $string == 'KEJ'){
                    $string = 'LAI';
                }
                $order['nama_paket'] = Str::upper($order->nama_paket);
                $order['created_at'] = Carbon::createFromFormat('Y-m-d H:i:s', $order['created_at']);
