...
class PaketController extends Controller
{
    ...
    public function viewPaket($test, $type){
        ...
        if($test == 'polri'){
            $test = 'POL';
            if($type == 'akademik-polri') $type = 'AKA';
            else $type = 'LAI';
        }
        else if($test == 'cpns'){
            $test = 'PNS';
            if($type == 'skd-cpns') $type = 'SKD';
            else if($type == 'skb-cpns') $type = 'SKB';
            else $type = 'LAI';
        }
        foreach($pakets as $paket){
            if($paket->latihan_soal!=0) continue;
            $string = $paket['id'];
            ...
            if($paket_test==$test and $paket_type==$type) $tampil->push($paket);
        }
    ...
    public function viewPaket2($test, $type, $type2){
        ...
        if($test == 'polri'){
            $test = 'POL';
            if($type2 == 'tes-kecerdasan') $type = 'PKC';
            else if($type2 == 'tes-kecermatan') $type = 'PCM';
            else if($type2 == 'tes-kepribadian') $type = 'PKR';
            else if($type2 == 'tes-pass-hand') $type = 'PPH';
            else if($type2 == 'paket-tes-polri') $type = 'PSI';
            else if($type2 == 'tes-pengetahuan-umum') $type = 'TPU';
            else if($type2 == 'tes-penalaran-numerik') $type = 'TPN';
            else if($type2 == 'tes-wawasan-kebangsaan') $type = 'TWK';
            else if($type2 == 'tes-bahasa-inggris') $type = 'TBG';
            else if($type2 == 'tes-bahasa-indonesia') $type = 'TBI';
            else if($type2 == 'tes-kesamaptaan-jasmani') $type = 'TKJ';
            else if($type2 == 'tes-pmk') $type = 'PMK';
            else if($type2 == 'tes-potensi-akademik') $type = 'TPA';
        }
        else if($test == 'cpns'){
            $test = 'PNS';
            if($type2 == 'cat-cpns') $type = 'CAC';
            else if($type2 == 'cat-sekdin') $type = 'CAS';
            else if($type2 == 'praktek-kerja') $type = 'PRA';
            else if($type2 == 'akademik-cpns') $type = 'AKA';
        }
        foreach($pakets as $paket){
            if($paket->latihan_soal!=0) continue;
            $string = $paket['id'];
    ...
    public function viewPaket3($test, $type, $type2, $type3){
        ...
        if($test == 'cpns'){
            $test = 'PNS';
            if($type3 == 'tes-kecermatan') $type = 'PCM';
            else if($type3 == 'tes-kecerdasan') $type = 'PKC';
            else if($type3 == 'tes-kepribadian') $type = 'PKR';
            else if($type3 == 'tes-kejiwaan') $type = 'KEJ';
        }
        foreach($pakets as $paket){
            if($paket->latihan_soal!=0) continue;
            $string = $paket['id'];
